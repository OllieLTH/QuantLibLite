...
- Add proper error handling throughout the library  
- Improve default behavior when invalid inputs are passed  
- Add input validation for all classes and functions  
- Extend to more complex derivatives and market models  
